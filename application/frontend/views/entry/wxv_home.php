          ...
          <div class="right_notice_section">
            ...
            <ol class="rounded-list" style="overflow: inherit;margin-bottom: 16px;">
              <?php  foreach ($week_article as $key => $week){?>
                <li>
                  <a style="padding: 0.6em .3em .0em 1.8em;" target="_bank" href="<?php echo base_url()?>core/wxc_content/read_article?article_id=<?=$week['article_id']?>"><span style="width: 237px;" class='gravatar' title="<?=$week['article_title']?>"><?=$week['article_title']?></span></a>
                </li>
              <?php }?>
