    ...
    <div class="foot_list_right">
      ...
      <div class="text_line" >
        ...
        <div style="font-size:13px"><img style="box-shadow: 2px 3px 2px #aaaaaa;" class="fl" src='/application/frontend/views/resources/images/version/creator_avatar.jpg'/>
          ...
          <p>男，还没有女朋友</p>
          <p>来自南京占地面积最大、校园风光最美的南京工程学院，12届毕业生</p>
          </div>
        </div>
        <p style="font-size:14px;padding-top: 120px;"><b>自我评价:</b></p>
        <p style="font-size:14px;">"四无"青年一个， 无房、无车、无女人、无存款^_^</p>
        <p style="font-size:14px;">从小学时代起就不喜欢各种考试，高考就更不用说了，说了一把泪水…</p>
        ...
        <p style="font-size:14px;">突然有一天，用C语言写了人生中第一个可运行的小程序，名叫“Hello world”，我勒个去，从此一发而不可收拾，疯狂的爱上了编程（其实说的好听一
          点就是大家经常听到的“程序猿”啦~~），现在我已经是南京某知名IT公司的独立项目负责人了，手上会6种程式设计语言（哈哈，羡慕吧~~）。</p>
        <p style="font-size:14px;">最欣赏的一部电影是《肖申克的救赎》，太赞了~~</p>
        <p style="font-size:14px;">最推荐的一部美剧是《越狱》，超喜欢男猪脚，从容淡定~~</p>
