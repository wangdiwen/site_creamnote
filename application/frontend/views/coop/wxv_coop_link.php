  ...
  <div class="body article_body">
    <div class="foot_list_left">
      ...
      <ul class="foot_list_ul">
        <li><a href="<?php echo site_url('static/wxc_cooperation/medium'); ?>" title="媒体报道">媒体报道</a></li>
        <li class="nowli"><a href="<?php echo site_url('static/wxc_cooperation/friendly_link'); ?>" title="友情链接">友情链接</a></li>
      </ul>
    </div>
