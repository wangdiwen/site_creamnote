...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    _FlexPaperViewersrc = config.FlexPaperViewersrc;
    _SWFFile  			= (config.SWFFile!=null?config.SWFFile:_SWFFile);
    ...
    window[instance] = flashembed(id, {
        //src						    : "/application/views/data/FlexPaperViewer.swf",
        //src                         : "http://wx-flash.oss.aliyuncs.com/FlexPaperViewer.swf",
        src                         :_FlexPaperViewersrc,
        version					    : [10, 0],
        //expressInstall			    : "/application/views/data/expressinstall.swf",
        expressInstall              : "http://wx-flash.oss.aliyuncs.com/expressInstall.swf",
        wmode					    : _WMode
    },{
        ElementId               : id,
        SwfFile  				: _SWFFile,
    ...
    function Flash(root, opts, conf) {
        ...
        if (f.isSupported(opts.version)) {
            ...
            if (!root.innerHTML.replace(/\s/g, '')) {
                ...
                root.innerHTML =
                    "<div style='padding: 180px 40px;color:red;'><h2 style='text-align: center;'>你的浏览还没有flash插件</h2>" +
                        "<h3 style='text-align: center;'>更新你的 Adobe Flash Player 到10或者更高 </h3>" +
                        "<p style='text-align: center;'>点击下载最新的Adobe Flash" +
                        "<a onclick='downloadFlash()' href='#'><img src='"
