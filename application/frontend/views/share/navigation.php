  ...
  <div id="header" class="_headShadow" style="width:100%;position: static;top: 0px;z-index: 888;">
    ...
    <div id="menu">
      <ul>
        ...
        <li class="<?php echo $nav_param=='upload_note'?'_current_page_item':'';?> nick "><a class="<?php echo !isset($_SESSION["wx_user_name"])&&isset($_SESSION["wx_user_email"])?'':'common_show_login_win' ;?>" href="javascript:void(0)" onclick="jump_to_uploadfile()">分享干货</a></li>
        <li class="<?php echo $nav_param=='upload_image'?'_current_page_item':'';?> nick "><a class="<?php echo !isset($_SESSION["wx_user_name"])&&isset($_SESSION["wx_user_email"])?'':'common_show_login_win' ;?>" href="javascript:void(0)" onclick="jump_to_uploadimage()">图片笔记</a></li>
