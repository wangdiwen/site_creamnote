...
<!--                       Javascripts                       -->
<!-- jQuery -->
<script type="text/javascript" src="/application/backend/views/js/jquery-1.3.2.min.js"></script>
...
<script type="text/javascript" src="/application/backend/views/js/jquery.datePicker.js"></script>
<script type="text/javascript" src="/application/backend/views/js/jquery.date.js"></script>
</head>
<body>
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <ul class="shortcut-buttons-set">
      <li><a class="shortcut-button" href="#"><span> <img src="/application/backend/views/images/icons/pencil_48.png" alt="icon" /><br />
        Write an Article </span></a></li>
      <li><a class="shortcut-button" href="#"><span> <img src="/application/backend/views/images/icons/paper_content_pencil_48.png" alt="icon" /><br />
        Create a New Page </span></a></li>
      <li><a class="shortcut-button" href="#"><span> <img src="/application/backend/views/images/icons/image_add_48.png" alt="icon" /><br />
        Upload an Image </span></a></li>
      <li><a class="shortcut-button" href="#"><span> <img src="/application/backend/views/images/icons/clock_48.png" alt="icon" /><br />
        Add an Event </span></a></li>
      <li><a class="shortcut-button" href="#messages" rel="modal"><span> <img src="/application/backend/views/images/icons/comment_48.png" alt="icon" /><br />
    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <div class="notification attention png_bg"> <a href="#" class="close"><img src="/application/backend/views/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href="#" title="Edit"><img src="/application/backend/views/images/icons/pencil.png" alt="Edit" /></a> <a href="#" title="Delete"><img src="/application/backend/views/images/icons/cross.png" alt="Delete" /></a> <a href="#" title="Edit Meta"><img src="/application/backend/views/images/icons/hammer_screwdriver.png" alt="Edit Meta" /></a> </td>
              </tr>
              <tr>
                <td>
                  <input type="checkbox" />
    ...
    <div class="notification information png_bg"> <a href="#" class="close"><img src="/application/backend/views/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
    ...
    <div class="notification success png_bg"> <a href="#" class="close"><img src="/application/backend/views/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
    ...
    <div class="notification error png_bg"> <a href="#" class="close"><img src="/application/backend/views/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
