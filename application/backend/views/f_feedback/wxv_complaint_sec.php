...
<div id="body-wrapper">
  ...
  <?php $menuParam='fed_complaint_sec';?>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="max-width:300px;">
                  <a href="#messages" rel="modal"><input onclick="teptwo_reason_detail('<?=$report['com_id']?>')" type="button" onclick="" class="button" value="查看原因"></a>
                  <input type="button" onclick="pass_complaint('<?=$report['com_id']?>',2)" class="button" value="驳回投诉">
