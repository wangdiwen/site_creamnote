      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          <table>
            ...
            <tbody>
              <?php  foreach ($report_step_one as $key => $report){?>
              <tr>
                <td>
                ...
                <td style="max-width:300px;">
                  ...
                  <input type="button" onclick="pass_complaint('<?=$report['com_id']?>',1)" class="button" value="驳回投诉">
    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab2">
          <?php if($has_download_tmp_file == "dio_truncate(fd, offset)"){?>
            <a href="<?php echo base_url(); ?>cnadmin/report/one_key_clear_download_tmp_file" ><input type="button" class="button" name="empty_temp_file" value="清空临时文件"></a>
          <?php }?>
        </div>
