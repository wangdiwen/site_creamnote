        ...
        <div class="tab-content default-tab" id="tab2">
          ...
          <table>
            ...
            <tbody id="query_by_user">
              <?php  foreach ($frontend_log_list as $key => $log){?>
              <tr>
                <td>
                ...
                <td style="max-width:300px;">
                  <input type="button" class="button" value="删除" onclick="delete_front_log('<?=$log?>')">
                  <a href="http://www.creamnote.com/cnadmin/share/frontend_log?log_name=<?=$log?>" target="_bank"><input type="button" class="button" value="查看"></a>
                </td>
              </tr>
