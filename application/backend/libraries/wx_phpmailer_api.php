...
/*****************************************************************************/
    public function __construct() {
        ...
        $this->CI->load->helper('phpmailer/phpmailerautoload');
        ...
        if ($to_user_email && $subject && $message) {
            ...
            if ($this->PHPMailer) {
                ...
                if ($this->PHPMailer->send()) {
                    ...
                    wx_loginfo('PHPMailer send failed: '.$this->PHPMailer->ErrorInfo, 'phpmailer_error');
                }
            }
        }
        return false;
...
/* End of file wx_phpmailer_api.php */
/* Location: /application/backend/controllers/wx_phpmailer_api.php */
