...
foreach ($oss_category as $oss_bucket => $obj_list) {
    ...
    if ($obj_list) {
        foreach ($obj_list as $obj) {
            ...
            wx_log("Data ObjectName: ".$data_objectname);
            wx_log("Data VPS Path  : ".$vps_data_file);
            wx_log("Data OSS Path  : ".'/'.$oss_bucket."/".$data_objectname);
