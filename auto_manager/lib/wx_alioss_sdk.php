...
/*****************************************************************************/
    /**
     *  以下为平台移植的阿里官方OSS开放存储服务sdk接口
     *  版本：OSS(Open Storage Services) PHP SDK v1.1.5
     *  说明：包含在原有的阿里官方OSS-php-sdk开发包中的文件为：
     *        1. oss_php_sdk_20121011/sdk.class.php
     */
/*****************************************************************************/
    /**
     *  定义加载的配置依赖的一些全局自定义变量
...
/*****************************************************************************/
    ...
    if(function_exists('get_loaded_extensions')){
        ...
        // die('get_loaded_extensions() no such function...');
...
/*****************************************************************************/
    ...
    class ALIOSS{
         ...
         * OSS服务地址
         */
        // const DEFAULT_OSS_HOST = 'oss.aliyuncs.com';              // 外网通信地址
        const DEFAULT_OSS_HOST = 'oss-internal.aliyuncs.com';  // 云主机使用OSS的内网地址与之通信
        ...
        public function auth($options){
            //开始记录LOG
            $msg = "---LOG START---------------------------------------------------------------------------\n";
            // echo $options[self::OSS_METHOD]."<br />";
            // echo $options[self::OSS_BUCKET]."<br />";
            // echo $options[self::OSS_OBJECT]."<br />";
            // if (! $this->validate_bucket($options[self::OSS_BUCKET]))
            // {
            //     echo 'OSS_BUCKET is invalid'.'<br />';
            // }
...
/* End of file alioss_sdk_helper.php */
/* Location: ./application/helpers/alioss_sdk_helper.php */
